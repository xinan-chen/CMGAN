...
parser.add_argument('--VCTK_data_path', type=str, default='/data/hdd1/xinan.chen/VCTK_flac_108s', help='data path')
parser.add_argument('--save_path', type=str, default='/data/hdd1/xinan.chen/VCTK_wav_trim', help='save path')
